...
t11,t12,t21,t22=TEMPS_TOT[25],TEMPS_TOT[25+1],TEMPS_TOT[35],TEMPS_TOT[35+1]

d1,d2=np.sqrt((LAT[25+1]-LAT[25])**2+(LON[25+1]-LON[25])**2+(ELE[25+1]-ELE[25])**2),np.sqrt((LAT[35+1]-LAT[35])**2+(LON[35+1]-LON[35])**2+(ELE[35+1]-ELE[35])**2)
