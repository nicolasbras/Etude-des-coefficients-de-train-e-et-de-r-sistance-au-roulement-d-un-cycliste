...
for i in range (1,13):
    ...
    LON=[i*R*np.pi/360 for i in LON]
    ...
    #VMOYCARRE.append()
    #ACC.append()
    P0.append(round((P[0]),4))
    P1.append(round((P[1]),4))
...
print("Cr : ",Cr[6:11])
print("Cx : ",Cx[6:11])
print("ordonnée à l'origine : ",round(mean(P1[6:11]),5))
print("coefficient directeur : ",round(mean(P0[6:11]),5))
print("Crmoy = ",round(mean(Cr[6:11]),5))
print("Cxmoy = ",round(mean(Cx[6:11]),5))
VMOYCARRE=np.array(VMOYCARRE[6:11])
ACCMOY=np.array(ACCMOY[6:11])
