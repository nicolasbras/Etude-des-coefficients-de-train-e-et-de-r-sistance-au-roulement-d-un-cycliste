...
txt_file_path = r"D:\Ecole\prépa\psi\Mesures_pneus_pression_tipe\5_bars_B.txt"
...
mode_path = r"D:\Ecole\prépa\psi\Mesures_pneus_pression_tipe\5_bars_B.txt"
...
for i in range(0,len(LAT)-1):
    ...
    D.append(d*1.875)#On multiplie par 1,875 car cela correspond mieux à la réalité mesurée par Strava (la distance totale mesurée est de 150m)
